...
// //     }
// //   })
// //   console.log (moviesTitleDescription);
// //   3) Movie title, description, genre
// //   //    TO GET THE GENRE NAME genre.name

// // let moviesGenreTitleDescription = movies.map ((movie, gen) => {
    
// //     const { genre: {name} } = gen ;
// //     const {title, description } = movie;
// //     return {
// //         title, 
// //         description, 
...
// // let moviesGenreTitleDescription = movies.map ((movie) => {
// //  return movie.title + movie.description + movie.genre.name;
    
// // })
// // console.log (moviesGenreTitleDescription);
// // 4) Movie title, description, genre name, director name

// let moviesGenreTitleDescriptionDirector = movies.map ((movie) => {
//      return movie.title +  movie.description +   movie.genre.name +   movie.director.name;
        
//     })

//     console.log (moviesGenreTitleDescriptionDirector);

// SECTION 2. EXERCISE THE .filter() map EXAMPLE let adventureMovies = (for the first task in this section)
...
// let yearMovies = movies.filter (movie => movie.release >= 2007)

// console.log(yearMovies);

// let advYearMovies = movies.filter (movie => (movie.release > 2011 && movie.genre.name === "Adventure"));

// console.log(advYearMovies);
...
// let createMoviesList = movies.map((imagine, title, releaseDate, genre, description) => {
//       const { picture, title, release,  genre, description } = movie;
